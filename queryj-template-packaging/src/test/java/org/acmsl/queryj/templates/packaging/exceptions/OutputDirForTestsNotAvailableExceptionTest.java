 ...
 ******************************************************************************
 *
 * Filename: OutputDirForTestsNotAvailableExceptionTest.java
 *
 ...
 * @since 3.0
 * Created: 2014/04/16 22:22
 */
@ThreadSafe
public class OutputDirForTestsNotAvailableExceptionTest
{
    /**
    ...
    {
        @NotNull final OutputDirForTestsNotAvailableException instance = new OutputDirForTestsNotAvailableException();
