 ...
 */
@ThreadSafe
public class TemplateFactoryTestHelper<TF extends TemplatePackagingTemplateFactory<T>, T extends TemplateWritingHandlerTemplate<C>, C extents DefaultTemplatePackagingContext>
{
    /**
