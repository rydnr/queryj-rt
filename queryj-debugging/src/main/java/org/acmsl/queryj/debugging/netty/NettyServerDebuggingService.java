    ...
    implements TemplateDebuggingService<C>
{
     ...
     */
    protected final void immutableSetNioEventLoopGroup(@NotNull final EventLoopGroup group)
    {
     ...
     * @param group the group.
     */
    protected void setNioEventLoopGroup(@NotNull final NioEventLoopGroup group)
    {
