...
public class AbstractTableAttributesListDecoratorTest
{
    ...
    public void getContainsClobs_works_when_there_are_clobs()
    {
        ...
        @NotNull final List<Attribute<String>> tableAttributes = new ArrayList<>();
        ...
        @NotNull final Attribute<DecoratedString> attribute = EasyMock.createNiceMock(Attribute<DecoratedString>.class)
