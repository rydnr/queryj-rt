...
public class CustomSqlValidationChainTest
{
        ...
        throws QueryJBuildException
    {
        ...
        @NotNull final Chain<QueryJCommand, QueryJBuildException, QueryJCommandHandler<QueryJCommand>> t_Chain = new Chain<>();
    ...
    protected boolean contains(
        ...
        @NotNull final Chain<QueryJCommand, QueryJCommandHandler<QueryJCommand>> chain)
    {
