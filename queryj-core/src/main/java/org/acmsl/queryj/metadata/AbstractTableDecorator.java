    ...
    implements  TableDecorator
{
    ...
    * @return such decorator.
     ...
     */
    @NotNull
    protected ListDecorator<Result<DecoratedString>> decorate(@NotNull final ListDecorator<Result<String>> results)
    {
    ...
    protected ListDecorator<Result<DecoratedString>> decorate(
        @NotNull final TableListDecorator<Result<String>> results,
        @NotNull final CustomSqlProvider customSqlProvider,
        @NotNull final MetadataManager metadataManager,
        @NotNull final DecoratorFactory decoratorFactory)
    {
    ...
    {
        return decorate(getCustomResults(getTable(), getCustomSqlProvider()));
    }
