    ...
    implements  TableDecorator
{
    ...
    * @return such decorator.
     ...
     */
    @NotNull
    protected TableDecorator createTableDecorator(@NotNull final Table<String, Attribute<String>, List<Attribute<String>> table)
    {
    ...
    {
        return decorate(createTableDecorator(), getCustomResults(getTable(), getCustomSqlProvider()));
    }
