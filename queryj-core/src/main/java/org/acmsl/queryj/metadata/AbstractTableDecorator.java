    ...
    implements  TableDecorator
{
    ...
    * @return such decorator.
     ...
     */
    @NotNull
    protected List<Attribute<String>> getAllAttributes(@NotNull final List<Attribute<String>> attributes, @Nullable final Table<String, Attribute<String>, List<Attribute<String>>> parent)
                                                        )
    {
