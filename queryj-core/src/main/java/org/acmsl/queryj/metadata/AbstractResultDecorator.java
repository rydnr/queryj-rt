                ...
                ResultDecorator
{
    ...
    {
        return containNullableAttribute(getProperties(), TableDecoratorHelper.getInstance());
    }
    ...
    protected boolean containNotNullProperties(
        ...
        @NotNull final TableDecoratorHelper tableDecoratorHelper)
    {
        return tableDecoratorHelper.containNotNullProperties(properties, metadataTypeManager);
    }
