                ...
                Serializable
{
    ...
    public String generate(
        final boolean relevantOnly, @Nullable final TemplateDebuggingService templateDebuggingService)
    ...
    protected String generate(
        ...
        @Nullable final TemplateDebuggingService templateDebuggingService)
        throws  InvalidTemplateException,
                DevelopmentModeException
    {
        final String result;
                    ...
                    try
                    {
                            ...
                            && (!relevantOnly))
                        {
                            synchronized (AbstractTemplate.class)
                            {
                                try
                                {
                                    templateDebuggingService.debugTemplate(this, co);//t_Template.inspect().waitForClose();
                                }
