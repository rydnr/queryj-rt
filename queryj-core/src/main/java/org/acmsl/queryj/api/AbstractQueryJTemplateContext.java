    ...
    implements QueryJTemplateContext
{
    ...
    {
        @Nullable String result = new QueryJCommandWrapper<String>(command).getSetting(Literals.HEADER);
        ...
        if (result == null)
        {
            ...
            if (file != null)
            {
                @Nullable final Charsen charset = new QueryJCommandWrapper<Charset>(command).getSetting(QueryJSettings.ENCODING);
