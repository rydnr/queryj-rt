    ...
    implements QueryJSettings
{
     ...
     */
    @Parameter (name = Literals.OUTPUTDIR, property = OUTPUT_FOLDER, required = false)
    private File m__OutputDir;

    /**
     * The data source.
     */
    @Parameter (name = Literals.JNDI_DATASOURCE, property = JNDI_DATASOURCE, required = false)
     ...
     * The grammar folder.
     */
    @Parameter (name = Literals.GRAMMAR_FOLDER, property = GRAMMAR_FOLDER, required = false)
    private File m__GrammarFolder;

    /**
     * The grammar bundle.
     */
    @Parameter (name = Literals.GRAMMAR_NAME, property = GRAMMAR_NAME, required = false)
     ...
     */
    @Parameter (name = Literals.DISABLE_TIMESTAMPS, property = DISABLE_TIMESTAMPS, required = false)
    private Boolean m__bDisableGenerationTimestamps;

    /**
     * Whether to disable NotNull annotations.
     */
    @Parameter (name = Literals.DISABLE_NOTNULL_ANNOTATIONS, property = DISABLE_NOTNULL_ANNOTATIONS, required = false)
    private Boolean m__bDisableNotNullAnnotations = false;

    /**
     * Whether to disable checkthread.org annotations.
     */
    @Parameter (property = DISABLE_CHECKTHREAD_ANNOTATIONS, required = false)
