    ...
    implements QueryJSettings
{
     ...
     * The data source.
     */
    @Parameter (name = Literals.JNDI_DATASOURCE, property = JNDI_DATASOURCE, required = false, defaultValue = "")
    private String m__strJndiDataSource;

    /**
     * The sql xml file.
     */
    @Parameter (name = Literals.SQL_XML_FILE, property = SQL_XML_FILE, required = false, defaultValue = "")
