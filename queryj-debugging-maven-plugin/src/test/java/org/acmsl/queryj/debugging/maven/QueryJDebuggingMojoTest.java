    ...
    extends AbstractMojoTestCase
{
        ...
        throws Exception
    {
        ...
        Assert.assertEquals("Invalid user", "QUERYJUSER", mojo.getUsername());
        ...
        Assert.assertEquals("Invalid JNDI data source""java:comp/env/jdbc/default", mojo.getJndiDataSource());
        Assert.assertEquals(
