 ...
 *
 * Description: Factory for DAOTemplates.
 *
...
/**
 * Factory for {@link DAOTemplate}s.
...
public class DAOTemplateFactory
    implements PerTableTemplateFactory<
               DAOTemplate, PerTableTemplateContext>,
               Singleton
{
    /**
        ...
        @NotNull final String tableName, @NotNull final MetadataManager metadataManager)
    {
        ...
        @NotNull final ST template =
            new ST("<engine.name><tableName.singular.camelCase>DAO.java");
