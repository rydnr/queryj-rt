 ...
 *
 * Filename: CucumberTableFeatureTemplateBuildHandler.java
 *
 * Description: Build handler for CucumberTableFeatureTemplates.
 *
...
import org.acmsl.queryj.templates.CucumberTableFeatureTemplateFactory;
...
/**
 * Build handler for {@link org.acmsl.queryj.templates.CucumberTableFeatureTemplate}s.
 ...
 */
@ThreadSafe
public class CucumberTableFeatureTemplateBuildHandler
    extends BasePerTableTemplateBuildHandler<
                CucumberTableFeatureTemplate,
                PerTableTemplateContext,
                CucumberTableFeatureTemplateFactory>
{
    /**
     * The key to access the templates in the command.
     */
    @NotNull static final String TEMPLATES_KEY = "CucumberTableFeature_templates";

    /**
     * Creates a {@code CucumberTableFeatureTemplateBuildHandler}.
     */
    public CucumberTableFeatureTemplateBuildHandler() {}

    /**
     * Retrieves the template factory.
     * @return the {@link CucumberTableFeatureTemplateFactory} instance.
     */
    @Override
    @NotNull
    protected CucumberTableFeatureTemplateFactory retrieveTemplateFactory()
    {
        return CucumberTableFeatureTemplateFactory.getInstance();
    }
        ...
        @SuppressWarnings("unused") @NotNull final String projectPackage)
    {
        ...
        @NotNull final ST packageTemplate = new ST("<packageName>.dao");
    ...
    protected void storeTemplates(
        @NotNull final List<CucumberTableFeatureTemplate> templates,
