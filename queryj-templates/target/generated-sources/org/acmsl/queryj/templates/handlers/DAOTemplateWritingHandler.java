 ...
 *
 * Description: Writing handler for DAOTemplates.
 *
...
/**
 * Writing handler for {@link DAOTemplate}s.
...
public class DAOTemplateWritingHandler
    extends BasePerTableTemplateWritingHandler<
                ...
                DAOTemplateGenerator>
{
    /**
     * Creates a new writing handler for {@link DAOTemplate templates}.
     */
    ...
    protected List<DAOTemplate> retrieveTemplates(@NotNull final QueryJCommand parameters)
    {
        ...
        @Nullable final List<DAOTemplate> aux =
            new QueryJCommandWrapper<List<DAOTemplate>>(parameters)
                .getSetting(DAOTemplateBuildHandler.TEMPLATES_KEY);
        ...
        @NotNull final PackageUtils packageUtils)
    {
        ...
        @NotNull final String packageName =
            DAOTemplateBuildHandler.buildPackageName(
