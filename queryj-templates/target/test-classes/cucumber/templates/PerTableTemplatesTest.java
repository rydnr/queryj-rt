...
import org.acmsl.queryj.templates.DAOTemplateGenerator;
                ...
                PerTableTemplateFactory<? extends PerTableTemplate<PerTableTemplateContext>, PerTableTemplateContext>>
{
    ...
    public PerTableTemplatesTest()
    {
        ...
        GENERATOR_MAPPINGS.put("CucumberTableFeature", new CucumberTableFeatureTemplateGenerator(false, 1));
        FACTORY_MAPPINGS.put("CucumberTableFeature", CucumberTableFeatureTemplateFactory.getInstance());
        PACKAGE_MAPPINGS.put("CucumberTableFeature", "<packageName>.dao");
        GENERATOR_MAPPINGS.put("DAO", new DAOTemplateGenerator(false, 1));
        FACTORY_MAPPINGS.put("DAO", DAOTemplateFactory.getInstance());
        PACKAGE_MAPPINGS.put("DAO", "<packageName>.dao.rdb.<engine.name.lowercased>");
    }
               ...
               || (restart))
        {
            ...
            for (@NotNull final Table<String, Attribute<String>, List<Attribute<String>>> table : tables.values())
            {
                ...
                @NotNull final String packageName =
                    resolvePackage(PACKAGE_MAPPINGS.get(templateName), resolveEngine(engine));
                ...
                ((AbstractTemplate) template).setDebugMode(true);
     ...
     */
    @NotNull
    protected String resolvePackage(@NotNull final String packageTemplate, @NotNull final Engine<String> engine)
    {
        ...
        @NotNull final TableTestHelper helper)
    {
        ...
        validateQueries(
            ...
            t_strJdbcPassword,
            retrieveCustomSqlProvider(getSqlList(), getParameters()),
            retrieveMetadataManager(engineName));
    }
